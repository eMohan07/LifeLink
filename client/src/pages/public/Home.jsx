  ...
  return (
    <div className="space-y-16 pb-12">
      ...
      <section className="relative pt-12 pb-16 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-rose-900/20 via-[#0b0f19] to-[#0b0f19] -z-10" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tight max-w-4xl mx-auto leading-tight">
            Connecting Lifesaving Donors to Emergency Needs in <span className="bg-clip-text text-transparent bg-gradient-to-r from-rose-500 via-rose-400 to-amber-400">Real Time</span>.
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              to="/find-donors"
              className="w-full sm:w-auto px-8 py-4 rounded-2xl glass-panel text-slate-200 hover:text-white font-bold text-base border border-slate-700 hover:border-rose-500/40 transition-all flex items-center justify-center space-x-2"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-panel rounded-3xl p-8 border border-slate-800 bg-[#151c2e]/80 relative overflow-hidden">
          <div className="text-center mb-8">
            <h2 className="text-xs font-bold uppercase tracking-widest text-rose-400 mb-2">The Closed-Loop Engine</h2>
            <h3 className="text-2xl font-bold text-white">How LifeLink Operates End-to-End</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4 text-center">
            {[
              ...
              <div key={index} className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex flex-col justify-between">
                <div>
                  <span className="text-2xl font-black text-rose-500/40 block mb-1">{item.step}</span>
